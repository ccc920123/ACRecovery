...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public static int QR_CODE = 1122;
    ...
    private void initView() {
        ...
        mLightTv = (TextView) findViewById(R.id.light_tv);
        mLightImg.setOnClickListener(click);
        mLightTv.setOnClickListener(click);
        isHasSurface = false;
    ...
    /**
     * 电筒是发打开，true为打开，false为关，默认为false
     */
    ...
    private View.OnClickListener click = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (v == mLightImg || v == mLightTv) {

                if (!getPackageManager().hasSystemFeature(PackageManager
                        .FEATURE_CAMERA_FLASH)) {
                    Toast.makeText(CaptureActivity.this, "当前设备不支持闪光灯", Toast.LENGTH_LONG).show();
                    return;
                }

                /*开关闪光灯*/
                isLightEnable(!lightIsOn);
                lightIsOn = !lightIsOn;
                if (lightIsOn) {
                    mLightImg.setImageDrawable(CaptureActivity.this.getResources().getDrawable(R.drawable
                            .light_on));
                } else {
                    mLightImg.setImageDrawable(CaptureActivity.this.getResources().getDrawable(R.drawable
                            .light_off));
